...
$paintings = [
    ...
    [
        ...
        "alt" => "Anaisha Devi",
        "paragraph-description" => "Anaisha Devi",
        "paragraph-complete" => "Sur cette id conceptuelle à la fois organique, minérale et liquide, Anaisha Devi nous transporte dans un nuage noir envoûtant. Un sombre tableau qui, par son verni éclatant, rayonne tel un marbre poli. Une oeuvre à la cohérence transcendantale, exécutée à la perfection."
    ],
    [
        "id" => 3,
        ...
        "alt" => "Andrew Forsythe",
        "paragraph-description" => "Andrew Forsythe",
        "paragraph-complete" => "Quisque accumsan ultrices ligula vestibulum posuere. Aliquam feugiat ligula eget massa blandit condimentum. Morbi volutpat erat luctus suscipit pellentesque. Quisque cursus tempor nibh at sollicitudin. Sed blandit libero velit. Etiam tincidunt facilisis mollis. Ut mollis nunc sit amet lacinia luctus. Suspendisse volutpat enim semper arcu rutrum, et iaculis risus interdum. Duis at libero."
    ],
    [
        "id" => 4,
    ...
    [
        ...
        "paragraph-description" => "Jean-Michel Delatronchette",
        "paragraph-complete" => "Vivamus commodo non libero at hendrerit. In lacinia dui sit amet pellentesque iaculis. Donec at ultricies sem porttitor."
    ],
    [
        "id" => 7,
        ...
        "alt" => "Hamish McKee",
        "paragraph-description" => "Hamish McKee",
        "paragraph-complete" => "Integer in nisl posuere, pulvinar ex ac, tincidunt risus. Nullam vel lorem et leo dignissim accumsan. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempor, magna non consectetur dapibus, est libero iaculis lacus, eget semper turpis orci vitae felis. Fusce eget molestie."
    ],
    [
        "id" => 8,
    ...
    [
        ...
        "paragraph-description" => "Martin Rodriguez",
        "paragraph-complete" => "Vivamus quis odio vel ligula feugiat facilisis. Donec eleifend pellentesque massa, ut malesuada est bibendum sit amet. Morbi tincidunt nec tellus vel ornare. Mauris dolor tellus, gravida eget euismod eu, viverra eget urna. Phasellus feugiat ipsum nec lorem accumsan, sed porta quam dictum massa nunc."
    ],
    [
        "id" => 11,
        "title" => "Asimilacion",
        ...
        "paragraph-description" => "Angel Sanchez-Fernandez",
        "paragraph-complete" => "Mauris ut justo ac mi pretium eleifend. Curabitur sed magna ut elit facilisis pharetra. Maecenas tincidunt fermentum ipsum ut sollicitudin. Nullam feugiat, neque vel egestas sollicitudin, quam leo mattis mauris, in lacinia sem mi id risus. Nullam ultrices quam eu leo auctor tempus. Fusce vestibulum mi ex, vel ultricies purus mollis sollicitudin. Aenean ac vehicula ipsum. Nam turpis ante, ultrices eget odio sed, luctus bibendum mauris sodales sed."
    ],
    [
        "id" => 12,
    ...
    [
        ...
        "alt" => "Sandro De Blasi",
        "paragraph-description" => "Sandro De Blasi",
        "paragraph-complete" => "Donec semper a massa quis congue. In malesuada lorem ligula, ut posuere magna pulvinar in. Proin vitae enim gravida, commodo odio."
    ],
    [
        "id" => 14,
        "title" => "Mirage",
    ...
    [
        ...
        "paragraph-description" => "Adelheid Von Schreiber",
    ...
    <article id="detail-oeuvre">
        ...
        <div id="contenu-oeuvre">
            ...
            <p class="description-complete">
                Curabitur dui odio, porta vel tempor sed, consectetur vitae mi. Interdum et malesuada fames ac ante
